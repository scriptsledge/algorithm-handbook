...
Ever wondered how to search in a sorted array that's been rotated? The trick is identifying which half is still sorted! 💡
...
• Step 2: Check if the target falls within that sorted range to decide where to move our pointers.
